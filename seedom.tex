...
\subsection{Unique Combination of Qualities}
...
Many methods exist for raising funds for charities. Outside of direct donations, some of the most popular include crowdfunding, matching gifts, drives, sales, auctions, events, lotteries, and raffles. All of these methods lack a few to many of our qualities.
...
Seedom's administration fee will be 5\% of all funds sent to the smart contract on a bimonthly basis. The remaining 95\% of the funds raised will be split evenly between the charity and the winner, with each receiving 47.5\%. Administration fees cover our expenses in four operational areas.
...
\section{Comparison to Other Platforms}
